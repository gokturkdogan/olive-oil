...
import { PaymentMethodList } from "@/components/admin/payment-method-list";
import { AddPaymentMethodButton } from "@/components/admin/add-payment-method-button";
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-white text-sm font-semibold">Ödeme Yöntemleri</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-white/90 font-medium max-w-2xl mx-auto">
              Müşterilerin ödeme yapabileceği yöntemleri yönetin
            </p>
          </div>
        </div>
      </div>
