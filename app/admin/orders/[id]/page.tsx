    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
              ...
              <div className="flex items-center gap-3">
                ...
                {order.refund_status === "MANUAL_REQUIRED" && (
                  <Badge className="bg-gradient-to-r from-red-600 to-red-700 text-white border-2 border-red-400 shadow-xl shadow-red-500/50 animate-pulse ring-2 ring-red-300 ring-opacity-50">
                    ...
                    <span className="font-bold text-base">MANUEL İADE GEREKLİ!</span>
                  </Badge>
                )}
              </div>
            </div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto space-y-6">
          {/* Manual Refund Completed Alert */}
          {order.refund_status === "MANUAL_COMPLETED" && (
            <Card className="border-2 border-green-300 shadow-xl shadow-green-500/20 bg-gradient-to-br from-green-50 to-emerald-100 ring-2 ring-green-200 ring-opacity-50">
          ...
          {/* Manual Refund Required Alert */}
          {order.refund_status === "MANUAL_REQUIRED" && (
            <Card className="border-2 border-red-300 shadow-xl shadow-red-500/20 bg-gradient-to-br from-red-50 to-red-100 ring-2 ring-red-200 ring-opacity-50">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                {order.refund_status && (
                  <div className="flex justify-between py-2 border-t border-gray-200 mt-3">
                    <span className="text-gray-600 font-semibold">İade Durumu:</span>
                    <Badge className={
                      order.refund_status === "MANUAL_REQUIRED" 
                        ? "bg-gradient-to-r from-red-600 to-red-700 text-white border-2 border-red-400 shadow-xl shadow-red-500/50 animate-pulse ring-2 ring-red-300 ring-opacity-50"
                        : order.refund_status === "AUTOMATIC_SUCCESS"
                      ...
                      {order.refund_status === "MANUAL_REQUIRED" && (
                        <span className="flex items-center gap-2">
                          ...
                          <span className="font-bold">MANUEL İADE GEREKLİ!</span>
                        </span>
                      )}
                      {order.refund_status === "AUTOMATIC_SUCCESS" && "Otomatik İade Başarılı"}
                      {order.refund_status === "MANUAL_COMPLETED" && "Manuel İade Tamamlandı"}
                      {order.refund_status === "NOT_APPLICABLE" && "İade Gerekmez"}
                    </Badge>
                  </div>
                )}
              </CardContent>
